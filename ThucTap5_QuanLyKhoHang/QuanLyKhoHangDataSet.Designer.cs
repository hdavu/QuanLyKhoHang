...
namespace ThucTap5_QuanLyKhoHang {
    ...
    public partial class QuanLyKhoHangDataSet : global::System.Data.DataSet {
        ...
        public partial class nhacungcapDataTable : global::System.Data.TypedTableBase<nhacungcapRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public nhacungcapRow AddnhacungcapRow(string ten, string diachi, string sdt, string masothue) {
...
namespace ThucTap5_QuanLyKhoHang.QuanLyKhoHangDataSetTableAdapters {
    ...
    public partial class nhacungcapTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[nhacungcap] WHERE (([ma] = @Original_ma) AND ([ten] = @Origina" +
                "l_ten) AND ([diachi] = @Original_diachi) AND ([sdt] = @Original_sdt) AND ([masot" +
                "hue] = @Original_masothue))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[nhacungcap] ([ten], [diachi], [sdt], [masothue]) VALUES (@ten," +
                " @diachi, @sdt, @masothue);\r\nSELECT ma, ten, diachi, sdt, masothue FROM nhacungc" +
                "ap WHERE (ma = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[nhacungcap] SET [ten] = @ten, [diachi] = @diachi, [sdt] = @sdt, [masothue] = @masothue WHERE (([ma] = @Original_ma) AND ([ten] = @Original_ten) AND ([diachi] = @Original_diachi) AND ([sdt] = @Original_sdt) AND ([masothue] = @Original_masothue));
SELECT ma, ten, diachi, sdt, masothue FROM nhacungcap WHERE (ma = @ma)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ma, ten, diachi, sdt, masothue FROM dbo.nhacungcap";
        ...
        public virtual int Fill(QuanLyKhoHangDataSet.nhacungcapDataTable dataTable) {
        ...
        public virtual QuanLyKhoHangDataSet.nhacungcapDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            QuanLyKhoHangDataSet.nhacungcapDataTable dataTable = new QuanLyKhoHangDataSet.nhacungcapDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(QuanLyKhoHangDataSet.nhacungcapDataTable dataTable) {
